...
| Date             | Changes                                                 |
| <2012-05-01 Tue> | Fixed some folder browsing bugs & improved context pane |
| <2012-04-27 Fri> | Added support for browsing folders, file-manager-style. |
